"""
Django settings for privacy_django project.
...
SECRET_KEY = '!vs$+ryj#^qsy(9-9q3#9q3%lli&!vq#+yamf891=+hc)0cyzg'
...
ROOT_URLCONF = 'privacy_django.urls'
...
WSGI_APPLICATION = 'privacy_django.wsgi.application'
